...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/07/05 20:31:09 by kcrius            #+#    #+#             */
/*   Updated: 2022/07/05 20:31:11 by kcrius           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	get_check_argv(t_data *data, char **av, int ac)
{
	...
	while (++i < ac)
	{
		if (ft_atoi(av[i], &(data->input_data[i - 1])) < 0)
			return (error("wrong param value\n"));
